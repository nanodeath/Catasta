require_relative 'catasta/common/parser'
require_relative 'catasta/optimizers/adjacent_text_optimizer'
require_relative 'catasta/version'

# Load targets
%w{ruby java15 javascript5}.each {|t| require_relative "catasta/#{t}/generator"; require_relative "catasta/#{t}/writer"}

# Load supporting classes
%w{front_matter_extractor embedded_commands_extractor line_number_mapper optimizer_list step}.each {|f| require_relative "catasta/core/#{f}"}
